...
/**
 * Building precipitation changes chart for specified period.
 */
public class PrecipitationChartBuilder implements ChartBuilder {
     ...
     * @return Result.
     */
    public <T> Plot designChart(List<T> data, List<LocalDate> period) {

        JFreeChart chart = createAreaChart((List<PrecipitationChangesData>) data, period);
     ...
     * @return Chart.
     */
    private JFreeChart createAreaChart(List<PrecipitationChangesData> data, List<LocalDate> period) {
